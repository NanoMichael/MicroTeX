...
\begin{array}{c}
  ...
  \begin{split}
      ...
      &\\
      &\textcolor{magenta}
          {\mathrm{Produit\ avec\ et\ \ par\ }\mathscr{C}\mathcal{A}\mathfrak{L}\mathbf{I}\mathtt{X}\mathbb{T}\mathsf{E}}\\
      &\begin{pmatrix}
...
\begin{array}{|c|c|c|c|}
  \hline
  \multicolumn{4}{|c|}{\shadowbox{\text{\Huge An image from the \LaTeX 3 project}}}\cr
  \hline
  \text{Left}\includegraphics{lion.png}\text{Right} & \text{Left}
      \includegraphics[width=3cm,interpolation=bicubic]{lion.png}\text{Right} & 
      \text{Left}\includegraphics[angle=45,width=3cm]{lion.png}\text{Right} & 
      \text{Left}\includegraphics[angle=160]{lion.png}\text{Right} \cr
  \hline
  \text{\backslash includegraphics\{lion.png\}} & 
      \text{\backslash includegraphics[width=3cm,interpolation=bicubic]\{lion.png\}} & 
      \text{\backslash includegraphics[angle=45,width=3cm]\{lion.png\}} 
          & \text{\backslash includegraphics[angle=160]\{lion.png\}}\cr
  \hline
\end{array}
